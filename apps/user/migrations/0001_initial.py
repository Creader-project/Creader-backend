    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', models.UUIDField(default=uuid.UUID('f1c88c04-c565-4353-bab0-b72c41b2dec0'), editable=False, unique=True, verbose_name='Public identifier')),
                ...
                ('role', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'Reader'), (4, 'Admin'), (3, 'Editor'), (2, 'Author')], default=1, null=True, verbose_name='Role')),
